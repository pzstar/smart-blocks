...
class Smart_Blocks_News_Module_Five {
    ...
    public function render($attributes) {
        ...
        $content_rendered .= '<div ' . get_block_wrapper_attributes(['class' => 'sb-news-module-five wp-block-sb']) . '>';
