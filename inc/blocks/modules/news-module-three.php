...
class Smart_Blocks_News_Module_Three {
    ...
    public function render($attributes) {
        ...
        $content_rendered .= '<div ' . get_block_wrapper_attributes(['class' => 'sb-news-module-three wp-block-sb']) . '>';
        ...
        while ($query->have_posts()):
            ...
            if ($index == 1) {
                ...
                $content_rendered .= '<h3 class="sb-post-title sb-large-title ' . smart_blocks_get_font_class($this->attributes['featuredTypographyFamily'], $this->attributes['featuredTypographyWeight'], $this->attributes['featuredTypographyTextTransform'], $this->attributes['featuredTypographyTextDecoration']) . '"><span>' . get_the_title() . '</span></h3>';
