...
export default function Edit({ attributes, setAttributes }) {
    ...
    const stylesCSS = `#${id} {
        ...
        ${featuredTitleMarginSmTop ? '--sb-featured-title-margin-top-sm: ' + featuredTitleMarginSmTop + ';' : ''}
        ${featuredTitleMarginSmRight ? '--sb-featured-title-margin-right-sm: ' + featuredTitleMarginSmRight + ';' : ''}
        ${featuredTitleMarginSmBottom ? '--sb-featured-title-margin-bottom-sm: ' + featuredTitleMarginSmBottom + ';' : ''}
        ${featuredTitleMarginSmLeft ? '--sb-featured-title-margin-left-sm: ' + featuredTitleMarginSmLeft + ';' : ''}
        ${featuredTitleMarginMdTop ? '--sb-featured-title-margin-top-md: ' + featuredTitleMarginMdTop + ';' : ''}
        ${featuredTitleMarginMdRight ? '--sb-featured-title-margin-right-md: ' + featuredTitleMarginMdRight + ';' : ''}
        ${featuredTitleMarginMdBottom ? '--sb-featured-title-margin-bottom-md: ' + featuredTitleMarginMdBottom + ';' : ''}
        ${featuredTitleMarginMdLeft ? '--sb-featured-title-margin-left-md: ' + featuredTitleMarginMdLeft + ';' : ''}
        ${featuredTitleMarginTop ? '--sb-featured-title-margin-top-lg: ' + featuredTitleMarginTop + ';' : ''}
        ${featuredTitleMarginRight ? '--sb-featured-title-margin-right-lg: ' + featuredTitleMarginRight + ';' : ''}
        ${featuredTitleMarginBottom ? '--sb-featured-title-margin-bottom-lg: ' + featuredTitleMarginBottom + ';' : ''}
        ${featuredTitleMarginLeft ? '--sb-featured-title-margin-left-lg: ' + featuredTitleMarginLeft + ';' : ''}

        ${sideTitleMarginSmTop ? '--sb-side-post-title-margin-top-sm: ' + sideTitleMarginSmTop + ';' : ''}
        ${sideTitleMarginSmRight ? '--sb-side-post-title-margin-right-sm: ' + sideTitleMarginSmRight + ';' : ''}
        ${sideTitleMarginSmBottom ? '--sb-side-post-title-margin-bottom-sm: ' + sideTitleMarginSmBottom + ';' : ''}
        ${sideTitleMarginSmLeft ? '--sb-side-post-title-margin-left-sm: ' + sideTitleMarginSmLeft + ';' : ''}
        ${sideTitleMarginMdTop ? '--sb-side-post-title-margin-top-md: ' + sideTitleMarginMdTop + ';' : ''}
        ${sideTitleMarginMdRight ? '--sb-side-post-title-margin-right-md: ' + sideTitleMarginMdRight + ';' : ''}
        ${sideTitleMarginMdBottom ? '--sb-side-post-title-margin-bottom-md: ' + sideTitleMarginMdBottom + ';' : ''}
        ${sideTitleMarginMdLeft ? '--sb-side-post-title-margin-left-md: ' + sideTitleMarginMdLeft + ';' : ''}
        ${sideTitleMarginTop ? '--sb-side-post-title-margin-top-lg: ' + sideTitleMarginTop + ';' : ''}
        ${sideTitleMarginRight ? '--sb-side-post-title-margin-right-lg: ' + sideTitleMarginRight + ';' : ''}
        ${sideTitleMarginBottom ? '--sb-side-post-title-margin-bottom-lg: ' + sideTitleMarginBottom + ';' : ''}
        ${sideTitleMarginLeft ? '--sb-side-post-title-margin-left-lg: ' + sideTitleMarginLeft + ';' : ''}
    ...
    const postInner = (post, block) => {
        ...
        const titleClass = block == 'featured' ? 'sb-large-title ' + getFontClass(featuredTypographyFamily, featuredTypographyWeight, featuredTypographyTextTransform, featuredTypographyTextDecoration) : getFontClass(sideTypographyFamily, sideTypographyWeight, sideTypographyTextTransform, sideTypographyTextDecoration);
    ...
    return (
        <>
            ...
            {headerTitleTypographyFamily && (<GoogleFontLoad family={headerTitleTypographyFamily} weight={headerTitleTypographyWeight.replace("italic", "i")} />)}
            {categoryTypographyFamily && (<GoogleFontLoad family={categoryTypographyFamily} weight={categoryTypographyWeight.replace("italic", "i")} />)}
            {featuredTypographyFamily && (<GoogleFontLoad family={featuredTypographyFamily} weight={featuredTypographyWeight.replace("italic", "i")} />)}
            {sideTypographyFamily && (<GoogleFontLoad family={sideTypographyFamily} weight={sideTypographyWeight.replace("italic", "i")} />)}
                            ...
                            <>
                                ...
                                >
                                    ...
                                    <RangeSliderControl
                                        ...
                                        setValue={(sideExcerptLength) => setAttributes({ sideExcerptLength })}
                                        min={0}
                                        max={600}
                                    />
                                    <ToggleControl
