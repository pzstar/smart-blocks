...
export default function Edit({ attributes, setAttributes }) {
    ...
    const stylesCSS = `#${id} {
        ...
        ${postTitleMargin.md.right ? '--sb-listing-post-title-margin-right-md: ' + postTitleMargin.md.righ + postTitleMargin.unitt +';' : ''}
    ...
    return (
        <>
                    ...
                    <div tabTitle={__("Layout", 'smart-blocks')}>
                        ...
                        >
                            <CustomRangeControl
                                ...
                                value={ noOfCol }
                                onChange={ ( noOfCol ) => setAttributes( {noOfCol} ) }
                                min={ 1 }
                                max={ 4 }
                            />
                            <CustomRangeControl
            ...
            <div id={id}>
                <div {...useBlockProps( {
                    className: "wp-block-smart-blocks sb-news-module-fourteen"
                } )}>
