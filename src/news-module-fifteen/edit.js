...
export default function Edit({ attributes, setAttributes }) {
    ...
    const stylesCSS = `#${id} {
        ...
        ${postTitleMargin.lg.right ? '--sb-listing-post-title-margin-right-lg: ' + postTitleMargin.lg.righ + postTitleMargin.unitt + ';' : ''}
        ...
        return (
            <div className="sb-post-item sb-clearfix" key={index}>
                ...
                <div class="sb-post-content">
                    ...
                    <h3 className={`sb-post-title ${postTypography}`}>
                        <a href={post.link}>
                            {post.title.rendered ? (
                                <RawHTML>
                                    {post.title.rendered}
    ...
    return (
        <>
            ...
            <div id={id}>
                <div {...useBlockProps({
                    className: "wp-block-smart-blocks sb-news-module-fifteen"
                })}>
