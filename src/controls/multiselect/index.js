...
class MultiSelectControl extends Component {
	...
	render() {
		const {
			disabled,
			label = __('Add item', 'smart-blocks'),
			instanceId,
			className,
		} = this.props;
...
MultiSelectControl.defaultProps = {
	...
	messages: {
		added: __('Item added.', 'smart-blocks'),
		removed: __('Item removed.', 'smart-blocks'),
		remove: __('Remove item', 'smart-blocks'),
	},
};
