...
export default function Edit({ attributes, setAttributes }) {
    ...
    const stylesCSS = `#${id} {
        ...
        ${featuredTitleColor ? '--sb-featured-title-color: ' + featuredTitleColor + ';' : ''}
        ${sideTitleColor ? '--sb-side-title-color: ' + sideTitleColor + ';' : ''}
        ${sideTitleHoverColor ? '--sb-side-title-hover-color: ' + sideTitleHoverColor + ';' : ''}
    ...
    const postInner = (post, block) => {
        ...
        const featuredContent = (
            <div class="sb-post-item">
                <div class="sb-post-thumb">
                    <a href={post.link}>
                        <div class="sb-thumb-container">
        ...
        return block == 'featured' ? featuredContent : sideContent;
    }
    ...
    return (
        <>
                    ...
                    <div className="sb-panel-tab-fields">
                        {'layout' === activeTab && (
                            ...
                            <>
                                ...
                                >
                                    <Color
                                        label={__('Featured Post Title Color', 'smart-blocks')}
                                        enableAlpha
                                        value={featuredTitleColor}
                                        onChange={(featuredTitleColor) => setAttributes({ featuredTitleColor })}
                                    />
                                    <Color
                                        label={__('Side Post Title Color', 'smart-blocks')}
                                        enableAlpha
                                        value={sideTitleColor}
                                        onChange={(sideTitleColor) => setAttributes({ sideTitleColor })}
                                    />
                                    <Color
                                        label={__('Side Post Title Color(Hover)', 'smart-blocks')}
                                        enableAlpha
                                        value={sideTitleHoverColor}
                                        onChange={(sideTitleHoverColor) => setAttributes({ sideTitleHoverColor })}
                                    />
                                    <Tabs>
            ...
            <div id={id}>
                <div {...useBlockProps({
                    className: "wp-block-smart-blocks sb-news-module-three"
                })}>
                    ...
                    <div className="sb-news-module-three-wrap">
