...
import { responsiveTypographyVars } from '../utils/helper';
...
export default function Edit({ attributes, setAttributes }) {
    ...
    const stylesCSS = `#${id} {
        ...
        ${featuredTitleMarginSmRight ? '--sb-featured-title-margin-right-sm: ' + featuredTitleMarginSm.righ + featuredTitleMarginUnitt + ';' : ''}
