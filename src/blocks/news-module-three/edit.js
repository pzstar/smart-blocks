                ...
                <div class="sb-post-thumb">
                    <a href={post.link}>
                        ...
                        <div class="sb-post-content sb-gradient-overlay">
                            <h3 className={`sb-post-title sb-large-title ${getFontClass(featuredTypographyFamily, featuredTypographyWeight, featuredTypographyTextTransform, featuredTypographyTextDecoration)}`}>
                                <span>
                                    {post.title.rendered ? (
                                        <RawHTML>
                                            {post.title.rendered}
        ...
        const sideContent = (
            <div className="sb-post-item">
                ...
                <div class="sb-post-content">
                    <h3 className={`sb-post-title ${getFontClass(sideTypographyFamily, sideTypographyWeight, sideTypographyTextTransform, sideTypographyTextDecoration)}`}>
                        <a href={post.link}>
                            {post.title.rendered ? (
                                <RawHTML>
                                    {post.title.rendered}
                            ...
                            <>
                                ...
                                >
                                    <ColorControl
                                        ...
                                        setValue={(featuredTitleColor) => setAttributes({ featuredTitleColor })}
                                    />
                                    <ColorControl
                                        label={__('Side Post Title Color', 'smart-blocks')}
                                        enableAlpha
                                        value={sideTitleColor}
                                        setValue={(sideTitleColor) => setAttributes({ sideTitleColor })}
                                    />
                                    <ColorControl
                                        label={__('Side Post Title Color(Hover)', 'smart-blocks')}
                                        enableAlpha
                                        value={sideTitleHoverColor}
                                        setValue={(sideTitleHoverColor) => setAttributes({ sideTitleHoverColor })}
                                    />
                                    <Tabs>
