...
export default function Edit({attributes, setAttributes}) {
    ...
    const postInner = (post, block) => {
        ...
        const titleClass = block == 'featured' ? 'sb-post-title ' + getFontClass(featuredTypographyFamily, featuredTypographyWeight, featuredTypographyTextTransform, featuredTypographyTextDecoration) : getFontClass(listingTypographyFamily, listingTypographyWeight, listingTypographyTextTransform, listingTypographyTextDecoration);
    ...
    return (
        <>
            ...
            <div id={id}>
                <div {...useBlockProps({
                    className: "sb-blocks sb-news-module-seven"
                })}>
