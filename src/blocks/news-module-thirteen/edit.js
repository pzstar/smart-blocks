...
export default function Edit(props) {
    ...
    const postInner = (post, index, primary) => {
        const featuredImage =
            post._embedded &&
        ...
        return (
            <div className="sb-alt-post-item sb-post-item" key={index}>
                ...
                <div class="sb-post-content">
                    <div class="sb-post-content-inner">
                        <div class="sb-post-content-wrap">
                            <div>
    ...
    return (
        <>
            ...
            <div id={id}>
                <div {...useBlockProps({
                    className: "wp-block-smart-blocks sb-news-module-thirteen"
                })}>
                    ...
                    <div className="sb-alternate-block">
